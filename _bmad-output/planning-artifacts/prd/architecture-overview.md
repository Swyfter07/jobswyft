...
| 4 | AI Studio tools | Match, Cover Letter, Outreach, Coach (chat). "Answer" API kept, not in v1 UI | User decision |
...
| 7 | Sidebar states | 3 states: Logged Out, Non-Job, Job Detected=Full Power | User decision |
